...
public class AddressRepositoryTest {
	...
	public void testAddNew() {
		...
		newAddress.setLastName("Abel Risk");
		newAddress.setPhoneNumber("190232344165");
		newAddress.setAddressLine1("4213 Gordon Street");
		newAddress.setAddressLine2("Lunadici Novak Building");
	...
	@Test
	public void testUpdateSetDefault() {
		Integer addressId = 1;
