...
public class BrandServiceTests {
	...
	@Test
	public void TestCreatNewBrandDulicate() {
		Integer id = null;
		String name = "Acer";
	...
	@Test
	public void TestUpdateBrandDuplicateById() {
		Integer id = 1;
		String name = "Asus";
		
		Brand newBrand= new Brand(id, name);
		
		Mockito.when(brandRepository.findByName(name)).thenReturn(newBrand);
		
		String check=brandService.checkUnique(2, name);
		assertThat(check).isEqualTo("Duplicate");
	}
}
