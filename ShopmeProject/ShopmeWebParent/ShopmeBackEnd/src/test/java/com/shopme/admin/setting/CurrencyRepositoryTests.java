...
public class CurrencyRepositoryTests {
	@Autowired
	private CurrencyRepository cuRepository;
	...
	public void testCreateCurrencies() {
		...
		cuRepository.saveAll(listCurrencies);
		
		Iterable<Currency> iterable = cuRepository.findAll();
	...
	public void testFindAllByOrderByNameAsc() {
		List<Currency> listCurrency = cuRepository.findAllByOrderByNameAsc();
		
		listCurrency.forEach(System.out::println);
		assertThat(listCurrency.size()).isGreaterThan(0);
	}
}
